...
const aiRequestGuard_1 = require("./middleware/aiRequestGuard");
...
(0, jwtSecret_1.assertJwtSecretConfigured)();
...
const restockV3Routes_1 = __importDefault(require("./routes/restockV3Routes"));
...
app.use('/api/restock-v3', authMiddleware_1.authenticate, restockV3Routes_1.default);
...
app.use('/api/chroma-adapt', authMiddleware_1.authenticate, productAtomicJsonMiddleware_1.chromaJsonParser, productAtomicJsonMiddleware_1.chromaJsonErrorHandler, aiRequestGuard_1.guardAiRequest, chromaAdaptRoutes_1.default);
app.use('/api/chroma-data', authMiddleware_1.authenticate, (0, authMiddleware_1.authorizeAnyPermission)('chroma-adapt.translate', 'chroma-adapt.edit', 'chroma-adapt.generate'), productAtomicJsonMiddleware_1.chromaJsonParser, productAtomicJsonMiddleware_1.chromaJsonErrorHandler, chromaRecordRoutes_1.default);
app.use('/api/usage', usageRoutes_1.default);
app.use('/api/dashboard', authMiddleware_1.authenticate, dashboardRoutes_1.default);
app.use('/api/product-analysis', authMiddleware_1.authenticate, productAtomicJsonMiddleware_1.productAnalysisUploadJsonParser, productAtomicJsonMiddleware_1.chromaJsonErrorHandler, aiRequestGuard_1.guardAiRequest, productAnalysisRoutes_1.default);
