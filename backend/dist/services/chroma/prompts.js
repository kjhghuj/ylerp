...
exports.COLOR_MAPPING_PROMPT = exports.SECONDARY_PLAN_PROMPT = void 0;
exports.buildEditAnalysisPrompt = buildEditAnalysisPrompt;
exports.buildColorAdaptationPrompt = buildColorAdaptationPrompt;
exports.buildTranslationPrompt = buildTranslationPrompt;
exports.SECONDARY_PLAN_PROMPT = `你是一位专业的视觉设计师和创意策划专家。请分析这张图片，然后设计一个配套的"副图"方案。
...
exports.COLOR_MAPPING_PROMPT = `你是一名顶级商业视觉设计师，擅长色彩理论与色彩迁移。
...
function buildEditAnalysisPrompt(userInstruction) {
...
function buildColorAdaptationPrompt(palette, styleConfig, colorMappingPlan) {
...
function buildTranslationPrompt(targetLang, targetFont) {
    const fontInstruction = targetFont !== 'original' ? `使用${targetFont}风格字体` : '严格保持原图的字体风格';
    return (`角色：你是一名顶级商业视觉设计师字体排版专家、专业的图像翻译专家、专业的图像编辑者、专业的语言翻译专家。` +
